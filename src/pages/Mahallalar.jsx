...
const getStatus = (complaints) =>
    complaints >= 60 ? "Muammoli" : complaints >= 30 ? "O'rta" : "Yaxshi";
...
const Mahallalar = () => {
  ...
  const { data: mahallasData, loading } = useApiData(api.getMahallalar, []);

  const filtered = mahallasData.filter((m) =>
          ...
          <div className="gov-card mb-6">
            <div className="relative">
              ...
              <input
                  ...
                  className="w-full h-10 pl-10 pr-4 rounded-xl bg-muted border-0 text-sm"
              />
            </div>
          </div>
          ...
          <div className="gov-card overflow-hidden">
            <Table>
              ...
              <TableBody>
                {loading && (
                    <TableRow>
                      <TableCell colSpan={5}>Yuklanmoqda...</TableCell>
                    </TableRow>
                )}
